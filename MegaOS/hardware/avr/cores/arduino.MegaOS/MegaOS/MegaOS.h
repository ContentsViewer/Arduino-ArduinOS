...
// MegaOS 
//
// MegaOSとは, Arduinoで使用できるOSです. 
// このOSを使用することで, マルチタスクによるプログラミングが可能になります.
// このOSの原型はFreeRTOSです.
// 
// システムフック:
//  MegaOSには, システムフックが用意されています.
...
/
// 設定:
//  MegaOSを正常に稼働させるためにハードウェアごとの設定が必要です.
//  MegaOS.h と同階層にMegaOSConfig.hを作成し, そのヘッダファイル内で各種設定を行って下さい.
...
//Include the generic headers required for the MegaOS port being used
#include <stddef.h>

#include <stdint.h>

//Basic MegaOS definitions
#include "ProjDefs.h"

// Application specific configuration options.
#include "MegaOSConfig.h"
...
//
    ...
    #error Missing definition: CONFIG_USE_PREEMPTION should be defined in MegaOSConfig.h as either 1 or 0.
#endif
...
//
    ...
    #error Missing definition: CONFIG_USE_IDLE_HOOK should be defined in MegaOSConfig.h as either 1 or 0.
#endif
...
//
    ...
    #error Missing definition: CONFIG_USE_TICK_HOOK should be defined in MegaOSConfig.h as either 1 or 0.
#endif
...
//
    ...
    #error Missing definition: CONFIG_USE_16_BIT_TICKS should be defined in MegaOSConfig.h as either 1 or 0.
#endif
...
//
    ...
    #error Missing definition: CONFIG_MINIMAL_STACK_SIZE should be defined in MegaOSConfig.h.
#endif
...
//
    ...
    #error Missing definition: CONFIG_TOTAL_HEAP_SIZE should be defined in MegaOSConfig.h.
#endif
...
//
    ...
    #error Missing definition: CONFIG_TICK_RATE_HZ should be defined in MegaOSConfig.h.
#endif
...
//
    ...
    #error Missing definition: INCLUDE_TASK_DELETE should be defined in MegaOSConfig.h as either 1 or 0.
#endif
...
//
    ...
    #error Missing definition: INCLUDE_TASK_SUSPEND should be defined in MegaOSConfig.h as either 1 or 0.
#endif
...
//
    ...
    #error Missing definition: INCLUDE_TASK_DELAY_UNTIL should be defined in MegaOSConfig.h as either 1 or 0.
#endif
...
//
    ...
    #error Missing definition: INCLUDE_TASK_DELAY should be defined in MegaOSConfig.h as either 1 or 0.
#endif
// Must define end ------------------------------------------------------
...
//  待機時間(ms)
//  
#define delay(ms) TaskDelay((ms) / PORT_TICK_RATE_MS)           
// ------------------------------------------------------
...
#define Acquire(semaphore, blockTime)                     \
    (SemahoreTake((semaphore), (PortTickType)(blockTime)) == PD_TRUE)
